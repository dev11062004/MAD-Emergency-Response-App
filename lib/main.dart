...
import 'package:public_emergency_app/mad_exam/providers/incident_provider.dart';
import 'package:public_emergency_app/mad_exam/services/hive_service.dart';void main() async {
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => IncidentProvider(hiveService)),
      ],
