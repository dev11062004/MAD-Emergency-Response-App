...
import 'package:public_emergency_app/mad_exam/screens/main_screen.dart' as mad;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Get.to(() => const mad.MainScreen());
        },
        label: const Text("MAD Exam Portal"),
        icon: const Icon(Icons.school),
        backgroundColor: Colors.red,
        heroTag: 'mad_portal_fab',
      ),
